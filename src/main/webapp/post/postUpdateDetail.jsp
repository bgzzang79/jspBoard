			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
					...
					<div class="col-sm-8 blog-main">
						...
						<form action="/postUpdate" id="updateFrm">
							<input type="submit" id="updateBtn" value="수정"/>
							<input type="hidden" name="pt_title" value="${postVo.pt_title }"/>
							<input type="hidden" name="pt_content" value="${postVo.pt_content}"/>
						</form>
						<form action="#" id="deleteFrm">
							<input type="submit" id="deleteBtn" value="삭제"/>
						</form>
						<form action="#" id="answerFrm">
							<input type="submit" id="answerBtn" value="답글"/>
						</form>
						</div>
					</div>
				</div>
